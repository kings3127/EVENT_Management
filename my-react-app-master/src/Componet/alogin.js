...
export default function FormPropsTextFields() {
  ...
  return (
    <body className='total1' style={{display: 'flex', justifyContent: 'center', alignItems: 'center', height: '90vh', backgroundImage: 'url()',backgroundSize:'cover',backgroundRepeat:'no-repeat'}}>
    <div>
